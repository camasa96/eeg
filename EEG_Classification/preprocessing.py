...
def load_raw_data(subject, test=False):
    ...
    data series 7 and 8.
    """
    fnames_train = glob('/Users/camasa/Documents/University/Grad/DM_Pro/train/subj%d_series*_data.csv' % (subject))
    fnames_train.sort()
    if test:
        fnames_test = glob('/Users/camasa/Documents/University/Grad/DM_Pro/test/subj%d_series*_data.csv' % (subject))
        fnames_test.sort()
    else:
