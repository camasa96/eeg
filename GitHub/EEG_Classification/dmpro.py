...
for subject in subjects:
    ...
    raw = []
    ################ READ DATA ################################################
    fnames =  glob('/Users/camasa/Documents/University/Grad/DM_Pro/train/subj%d_series*_data.csv' % (subject))
    for fname in fnames:
    ...
    ################ Read test data #####################################
    #
    fnames =  glob('/Users/camasa/Documents/University/Grad/DM_Pro/test/subj%d_series*_data.csv' % (subject))
    test = []
    idx=[]
    for fname in fnames:
